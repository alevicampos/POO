...
public class Libro {
    ...
    public void devolver(Estudiante estudiante) {
        if (!disponible && estudiante.getLibroPrestado().contains(this)) {
            ...
            librosDisponibles++;
            estudiantePrestado.setLibroPrestado(null);
            estudiantePrestado = null;
        } else {
            System.out.println("El libro " + getTitulo() + " no se puede devolver. Está disponible o no pertenece a este estudiante.");
        }
    }
